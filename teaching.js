...
function supportMap(){return `${lessonHead('求助，可以从<mark class="focus-key focus-green">一句话</mark>开始。','不必等到特别严重，才值得被帮助。')}<div class="support-map"><article><span class="map-symbol" aria-hidden="true">◎</span><h2>可以找谁</h2><p>可信任的家人<br>班主任或心理老师<br>校医或专业人员</p></article><article><span class="map-symbol" aria-hidden="true">“</span><h2>第一句怎么说</h2><p class="help-quote">“最近这件事让我很难受，<br>也影响了上课。<br>可以找个时间帮我吗？”</p></article><article><span class="map-symbol" aria-hidden="true">↗</span><h2>没帮上忙怎么办</h2><p>再找另一位可信任的大人。<br>可以请朋友陪同，<br>不用独自承担。</p></article></div><p class="support-urgent"><strong>涉及伤害或眼前危险：</strong>先到安全处，立即找能提供帮助的大人；不要独自等待消息。</p>`}
function practiceBridge(){return `${lessonHead('练习之后，把方法带回生活。','不评谁更放松。我们关心：<mark class="focus-key focus-purple">发现了什么</mark>，<mark class="focus-key focus-green">下一步怎么做？</mark>')}<div class="bridge-steps"><article><span>① 刚才</span><h2>我的注意在哪里？</h2><p>颜色、边缘、身体支撑，或者又想到了别的事。</p></article><article><span>② 发现</span><h2>走神之后，发生了什么？</h2><p>可以再回来；不舒服时，也可以停下来。</p></article><article><span>③ 下一步</span><h2>现在愿意先做什么？</h2><p>“我先圈出一个问题，下课请老师帮我。”</p></article></div>${takeaway('观察是短暂的缓冲。练完以后，困难仍可以继续处理，也可以求助。')}`}
...
const teachingNotes={
 ...
 7:['对话示范与支持地图','四分钟活动：说明30秒，30秒双人有声对话或45秒有声短片二选一，辨认回应方式约75秒，同桌练一句约90秒。两分钟回顾：看支持地图，默想可联系的人；不要求报姓名。示范“最近很难受，想找个时间请您帮忙”。第一位没回应可继续找，眼前危险不独自等消息。']
};
